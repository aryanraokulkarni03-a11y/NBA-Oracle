...
## Purpose
Use this runbook to operate NBA Oracle after the Phase 6 convenience and automation layer lands.

Phase 6 is about four practical things:
- starting the hosted stack more easily
...
Normal hosted usage now starts from:
...
- backend is available for hosted access when you need the dashboard
